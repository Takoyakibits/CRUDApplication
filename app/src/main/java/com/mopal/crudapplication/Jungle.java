    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toplane.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Jungle.this, Toplane.class);
        ...
        Midlane.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Jungle.this, Midlane.class);
                startActivity(intent);
            }
        });
        ...
        Botlane.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Jungle.this, Bottomlane.class);
                startActivity(intent);
            }
        });
        ...
        Support.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Jungle.this, Support.class);
                startActivity(intent);
            }
        });
        ...
        Rank.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Jungle.this, leaderboard.class);
                startActivity(intent);
            }
        });
    }
